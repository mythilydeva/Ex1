...
public class ScndActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState){
		 ...
		 result1 = (TextView) findViewById(R.id.text3);
		 result2 = (TextView) findViewById(R.id.text4);
		 Typeface tfont=Typeface.createFromAsset(getAssets(), "AlexBrush-Regular.ttf");
		 Typeface t1font=Typeface.createFromAsset(getAssets(), "Amble-Italic.ttf");
		 Typeface t2font=Typeface.createFromAsset(getAssets(), "KaushanScript-Regular.otf");
		 Intent i = getIntent();
